...
pub const DONA_REJECTED_EVENT_TYPE: &str = "dona.dona_rejected";

#[derive(Debug, Clone, Hash, PartialEq, Eq)]
pub struct DonaRejectedEvent {
    dona_id: String,
...
impl Event for DonaRejectedEvent {
    fn event_type(&self) -> &'static str {
        DONA_REJECTED_EVENT_TYPE
    }
