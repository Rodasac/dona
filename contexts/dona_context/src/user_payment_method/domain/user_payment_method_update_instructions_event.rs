...
pub const USER_PAYMENT_METHOD_INST_UPDATED: &str = "dona.user_payment_method_instructions_updated";

#[derive(Debug, Clone, Hash, PartialEq, Eq)]
pub struct UserPaymentMethodInstructionsUpdatedEvent {
    id: String,
    user_id: String,
...
impl UserPaymentMethodInstructionsUpdatedEvent {
    pub fn new(
        id: String,
        user_id: String,
        payment_method: String,
...
impl Event for UserPaymentMethodInstructionsUpdatedEvent {
    fn event_type(&self) -> &'static str {
        USER_PAYMENT_METHOD_INST_UPDATED
    }
    ...
    fn from_primitives(
        ...
        Ok(Box::new(UserPaymentMethodInstructionsUpdatedEvent {
            id: id.to_string(),
